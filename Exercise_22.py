            ...
            if user_choice not in('yes', 'no', 'y', 'n'):
                ...
                with open('Report.txt', 'w') as file:
                    ...
                    for student, subjects in self.Students.items():
                        ...
                        if count_grade_student > 0:
                            average_grade_student = total_grades_student / count_grade_student
                        else:
...
grades.teacher_gets_grades()
grades.calculate_stats()
grades.generate_report()